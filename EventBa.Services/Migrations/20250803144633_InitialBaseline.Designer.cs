...
namespace EventBa.Services.Migrations
{
    ...
    [Migration("20250803144633_InitialBaseline")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EventBa.Services.Database.Tag", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("EventTag", b =>
                {
                    ...
                    b.HasOne("EventBa.Services.Database.Tag", null)
                        .WithMany()
                        .HasForeignKey("TagId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
